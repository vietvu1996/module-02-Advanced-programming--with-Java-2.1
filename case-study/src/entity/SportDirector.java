...
public class SportDirector extends User {
    ...
    public SportDirector(UserType userType, String username, String password, String name, int age, String gender, String jobBefore, int yearsContract, double salary) {
